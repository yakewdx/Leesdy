...
public class LDDiarizationBase extends Thread{

	/** The Constant logger. */
	private final static Logger logger = Logger.getLogger(LDDiarizationBase.class.getName());
	...
	static ArrayList<LDDiarizationBase> diarizationList;
 ...
 */
	...
	public boolean isThreadAlive() {
		for (LDDiarizationBase diarization : diarizationList) {
	...
	public void ester2DiarizationCorpus(Parameter parameter) throws DiarizationException, Exception {
		...
		diarizationList = new ArrayList<LDDiarizationBase>(nbThread);

		for (int i = 0; i < nbThread; i++) {
			diarizationList.add(new LDDiarizationBase());
	...
	public static void main(String[] args) {
		try {
			...
			if (parameter.show.isEmpty() == false) {
				LDDiarizationBase diarization = new LDDiarizationBase();
